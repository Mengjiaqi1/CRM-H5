...
export default {
  ...
  async created() {
    if (dd.env.platform != 'notInDingTalk') {
      ...
      setCookie(
        'tokenKey',
        'eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6ImEyOTE2YWQ2LTUxM2YtNGU5YS1iYTE3LThiMDc2MDRlNzE4MCJ9.AAbj1D1m-_ctw8esWiYd-tnEx2liyetCio96xtvP-VmFgVJ0X-siDmv4jRz1xVt7x-b8wIczdeynjYqwIBa8hg'
      )
