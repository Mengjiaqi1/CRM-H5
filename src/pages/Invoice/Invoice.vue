      ...
      <div class="invoice_content">
        ...
        <form class="form"
          ...
          <template>
            <div @click="onSearch"
                 class="search">
              <img src="../../common/images/search2.png"
                   alt="" />
            </div>
          </template>
        </form>
          ...
          <van-pull-refresh v-model="isLoading"
            ...
            <van-list v-model="loading"
              ...
              <router-link tag="div"
                  ...
                  query: { id: item.id, number: item.number }
                }">
                <div class="main_tit">
                  ...
                  <p>
                    <span class="company">{{ item.accountName }}</span>
                  </p>
                </div>
                <div class="space"></div>
              </router-link>
...
<script>
import { getInvoiceData } from "../../services/invoice";
